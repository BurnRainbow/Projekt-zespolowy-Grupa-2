...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\KontaktController' => 'getKontaktControllerService',
            'App\\Controller\\KontaktapiController' => 'getKontaktapiControllerService',
            'App\\Controller\\MainController' => 'getMainControllerService',
            'App\\Controller\\NotatkaController' => 'getNotatkaControllerService',
            'App\\Controller\\StronaGlownaController' => 'getStronaGlownaControllerService',
            'App\\Controller\\SuccessKontaktController' => 'getSuccessKontaktControllerService',
            'App\\Controller\\SuccessNotatkaController' => 'getSuccessNotatkaControllerService',
            'App\\Controller\\balwan' => 'getBalwanService',
            'App\\Controller\\balwan2' => 'getBalwan2Service',
            'App\\Controller\\entity' => 'getEntityService',
            'App\\Controller\\mnozenie' => 'getMnozenieService',
            'App\\Controller\\wip' => 'getWipService',
            'App\\Controller\\wip2' => 'getWip2Service',
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'E:\\symfony');
        $a->addPath('E:\\symfony\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('E:\\symfony\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('E:\\symfony\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('E:\\symfony\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('E:\\symfony\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('E:\\symfony\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('E:\\symfony\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('E:\\symfony\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('E:\\symfony\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('E:\\symfony\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('E:\\symfony/templates');
        $a->addPath('E:\\symfony\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('E:\\symfony\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('E:\\symfony\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($f, 'E:\\symfony', 'UTF-8'));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('UbPDWirGk8', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nhn9wqiR3d', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tNEERZ++74', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\NotatkaRepository' => ['privates', 'App\\Repository\\NotatkaRepository', 'getNotatkaRepositoryService', true],
        ], [
            'App\\Repository\\KontaktRepository' => '?',
            'App\\Repository\\NotatkaRepository' => '?',
        ])));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sp3pO1HK1F', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FTUzZGtlMG', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zYG9bQz21J', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ne600DUJlc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TkodNK79pY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wa3J9VMqZV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'E:\\symfony', function () {
    ...
    {
        return $this->privates['doctrine.orm.default_annotation_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => 'E:\\symfony\\src\\Entity']);
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf'], 'fr' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf'], 'gl' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf'], 'hy' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf'], 'id' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf'], 'it' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf'], 'ja' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mn' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf'], 'nn' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf'], 'pt' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf'], 'pt_BR' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf'], 'ru' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf'], 'sk' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf'], 'uk' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf'], 'ur' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf']], 'scanned_directories' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations', 3 => 'E:\\symfony/translations', 4 => 'E:\\symfony\\vendor\\symfony\\framework-bundle/translations', 5 => 'E:\\symfony\\vendor\\doctrine\\doctrine-bundle/translations', 6 => 'E:\\symfony\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 7 => 'E:\\symfony\\vendor\\symfony\\debug-bundle/translations', 8 => 'E:\\symfony\\vendor\\symfony\\twig-bundle/translations', 9 => 'E:\\symfony\\vendor\\symfony\\web-profiler-bundle/translations', 10 => 'E:\\symfony\\vendor\\twig\\extra-bundle/translations', 11 => 'E:\\symfony\\vendor\\symfony\\security-bundle/translations', 12 => 'E:\\symfony\\vendor\\symfony\\monolog-bundle/translations', 13 => 'E:\\symfony\\vendor\\symfony\\maker-bundle\\src/translations', 14 => 'E:\\symfony\\vendor\\sensio\\framework-extra-bundle\\src/translations'], 'cache_vary' => ['scanned_directories' => [0 => 'E:\\symfony\\vendor\\symfony\\validator/Resources/translations', 1 => 'E:\\symfony\\vendor\\symfony\\form/Resources/translations', 2 => 'E:\\symfony\\vendor\\symfony\\security-core/Resources/translations', 3 => 'translations', 4 => 'E:\\symfony\\vendor\\symfony\\framework-bundle/translations', 5 => 'E:\\symfony\\vendor\\doctrine\\doctrine-bundle/translations', 6 => 'E:\\symfony\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 7 => 'E:\\symfony\\vendor\\symfony\\debug-bundle/translations', 8 => 'E:\\symfony\\vendor\\symfony\\twig-bundle/translations', 9 => 'E:\\symfony\\vendor\\symfony\\web-profiler-bundle/translations', 10 => 'E:\\symfony\\vendor\\twig\\extra-bundle/translations', 11 => 'E:\\symfony\\vendor\\symfony\\security-bundle/translations', 12 => 'E:\\symfony\\vendor\\symfony\\monolog-bundle/translations', 13 => 'E:\\symfony\\vendor\\symfony\\maker-bundle\\src/translations', 14 => 'E:\\symfony\\vendor\\sensio\\framework-extra-bundle\\src/translations']]], []);
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'E:\\symfony\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'E:\\symfony\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'E:\\symfony\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'E:\\symfony\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'E:\\symfony\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'E:\\symfony\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'E:\\symfony\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'E:\\symfony\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'E:\\symfony\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'E:\\symfony\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'E:\\symfony\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'E:\\symfony\\vendor\\sensio\\framework-extra-bundle\\src',
            ...
            'translator.default_path' => 'E:\\symfony/translations',
            ...
            'twig.default_path' => 'E:\\symfony/templates',
